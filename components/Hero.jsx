...
const Hero = () => {
  return (
    <section className='py-12 xl:py-26 h-[94vh] xl:pt-20 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none'>
      <div className='container mx-auto '>
        <div className='flex justify-between gap-x-8'>
          {/* text */}
          <div className='flex max-w-[600px] flex-col justify-center mx-auto xl:mx-12 text-center xl:text-left'>
            ...
            <p className='subtitle max-w-[600px] mx-auto xl:mx-0'>
              Hiya, my name is Tiffany! I'm a student at the University of Virginia, pursuing a dual major in computer science and cognitive neuroscience with a minor in engineering business. My passion lies in enhancing and designing technology for the human experience.
            </p>
            {/* buttons */}
